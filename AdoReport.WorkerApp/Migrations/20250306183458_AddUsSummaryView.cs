...
{
    /// <inheritdoc />
    public partial class AddUsSummaryView : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
CREATE OR REPLACE VIEW ""UsSummary"" AS
SELECT
    row_number() OVER () AS ""No"",
    wi.""Fields""->>'System.AreaLevel2' AS ""Team"",
    wi.""Fields""->>'System.IterationLevel2' AS ""Sprint"",
    wi.""Fields""->>'System.Id' AS ""ID"",
    concat('https://dev.azure.com/AssetHealthInsights/Asset%20Backlogs/_workitems/edit/', wi.""Fields""->>'System.Id') AS ""US Link"",
    ...
    (
        COALESCE((wi.""Fields""->>'Custom.TotalDevEffort')::float, 0)
        + COALESCE((wi.""Fields""->>'Custom.TotalQCEffort')::float, 0)
        + COALESCE((wi.""Fields""->>'Custom.TotalBAEffort')::float, 0)
        + COALESCE((wi.""Fields""->>'Custom.TotalDevOpsEffort')::float, 0)
...
");
        ...
        {
            migrationBuilder.Sql(@"DROP VIEW IF EXISTS ""UsSummary"";");
        }
    }
}
